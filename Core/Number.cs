...
namespace Luny
{
    ...
    /// </summary>
    [Serializable]
    public readonly struct Number : IComparable, IConvertible, IFormattable, IComparable<Number>, IEquatable<Number>, IComparable<Double>, IEquatable<Double>
    {
        private readonly Double _value;

        public Number(Double value) => _value = value;

        #region Implicit Conversions from Primitive Types to Number

        public static implicit operator Number(Double value) => new Number(value);
        public static implicit operator Number(Single value) => new Number(value);
        public static implicit operator Number(Int32 value) => new Number(value);
        public static implicit operator Number(Int64 value) => new Number(value);
        public static implicit operator Number(Int16 value) => new Number(value);
        public static implicit operator Number(Byte value) => new Number(value);
        public static implicit operator Number(UInt32 value) => new Number(value);
        public static implicit operator Number(UInt64 value) => new Number(value);
        public static implicit operator Number(UInt16 value) => new Number(value);
        public static implicit operator Number(SByte value) => new Number(value);
        public static implicit operator Number(Decimal value) => new Number((Double)value);
        public static implicit operator Number(Boolean value) => new Number(value ? 1.0 : 0.0);
        public static implicit operator Number(String value) => new Number(String.IsNullOrEmpty(value) ? 0.0 : Convert.ToDouble(value, CultureInfo.InvariantCulture));

        #endregion

        #region Implicit Conversions from Number to Primitive Types
        ...
        {
            if (obj is Number other) return Equals(other);
            if (obj is Double d) return _value.Equals(d);
            return false;
        }
        ...
        public Int32 CompareTo(Object obj)
        {
            ...
            if (obj is Number other) return _value.CompareTo(other._value);
            if (obj is Double d) return _value.CompareTo(d);
