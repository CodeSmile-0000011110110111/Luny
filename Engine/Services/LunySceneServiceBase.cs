...
namespace Luny.Engine.Services
{
	...
	public interface ILunySceneService : ILunyEngineService
	{
		...
		/// </summary>
		IReadOnlyList<LunyGameObject> GetObjects(IReadOnlyCollection<String> objectNames);

		/// <summary>
		/// Finds a LunyObject by name in the current scene.
		/// </summary>
		LunyGameObject FindObjectByName(String name);

		/// <summary>
		/// Finds a named child object under <paramref name="parent"/> (depth-first, includes inactive).
		/// Returns null if not found.
		/// </summary>
		LunyGameObject FindChildByName(LunyGameObject parent, String name);
	}
	...
	public abstract class LunySceneServiceBase : LunyEngineServiceBase, ILunySceneService, ILunySceneServiceInternal
	{
		...
		public abstract IReadOnlyList<LunyGameObject> GetObjects(IReadOnlyCollection<String> objectNames);
		public abstract LunyGameObject FindObjectByName(String name);
		public abstract LunyGameObject FindChildByName(LunyGameObject parent, String name);
