...
namespace Luny.Engine.Bridge
{
	public static class VectorUtil
	{
		...
		public static LunyVector3 ClearX(LunyVector3 v) => new(0d, v.Y, v.Z);

		/// <summary> Returns a copy of <paramref name="v"/> with the Y component set to zero. </summary>
		public static LunyVector3 ClearY(LunyVector3 v) => new(v.X, 0d, v.Z);

		/// <summary> Returns a copy of <paramref name="v"/> with the Z component set to zero. </summary>
		public static LunyVector3 ClearZ(LunyVector3 v) => new(v.X, v.Y, 0d);
		...
		/// <param name="lockAxis">Per-axis multiplier (0 locks that axis, 1 keeps it).</param>
		...
		internal static Boolean TryGetMaskedDirection(LunyVector3 from, LunyVector3 to, LunyVector3 lockAxis,
			out LunyVector3 maskedDirection)
		{
			maskedDirection = (to - from) * lockAxis;
